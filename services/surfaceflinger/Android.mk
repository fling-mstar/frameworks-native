...
ifneq ($(ENABLE_HWCOMPOSER_13),true)
...
ifeq ($(ENABLE_HWCOMPOSER_13),true)
    LOCAL_C_INCLUDES += hardware/mstar/gralloc2
    LOCAL_CFLAGS += -DENABLE_HWCOMPOSER_13
else
    LOCAL_C_INCLUDES += hardware/mstar/gralloc
endif

ifeq ($(BUILD_MSTARTV),mi)
    LOCAL_C_INCLUDES += \
        device/mstar/common/libraries/mi/include \
        device/mstar/common/libraries/mi/include/datatype
