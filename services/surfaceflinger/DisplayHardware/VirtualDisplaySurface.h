...
#ifdef BUILD_FOR_STB
    virtual void reSetPanelSize(int width, int height);
    virtual status_t reSetGopSize(int width, int height, int hstart, int interleave, int orientation, int value);
    virtual status_t getAdjustValue(int *adjustwidth, int *adjustheight,int* adjustloffset, int* adjusttopoffset);
#endif
