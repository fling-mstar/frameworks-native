...
int VirtualDisplaySurface::getOsdWidth() const {
    return 0;
}

int VirtualDisplaySurface::getOsdHeight() const {
    return 0;
}
...
// MStar Android Patch Begin
#ifdef BUILD_FOR_STB
void VirtualDisplaySurface::reSetPanelSize(int width, int height) {
}

status_t VirtualDisplaySurface::reSetGopSize(int width, int height, int hstart, int interleave, int orientation, int value) {
    return NO_ERROR;
}

status_t VirtualDisplaySurface::getAdjustValue(int *adjustwidth, int *adjustheight,int* adjustloffset, int* adjusttopoffset) {
    return NO_ERROR;
}
#endif

void VirtualDisplaySurface::recalc3DTransform(Transform** first, Transform** second, Rect& frame){
}

void VirtualDisplaySurface::getCurTiming(int *width, int *height) {
}
// MStar Android Patch End
