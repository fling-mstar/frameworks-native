...
#ifdef BUILD_FOR_STB
void FramebufferSurface::reSetPanelSize(int width, int height) {
    mHwc.reSetPanelSize(width, height);
}

status_t FramebufferSurface::reSetGopSize(int width, int height, int hstart, int interleave, int orientation, int value) {
    return mHwc.reSetGopSize(width, height, hstart, interleave, orientation, value);
}

status_t FramebufferSurface::getAdjustValue(int *adjustwidth, int *adjustheight,int* adjustloffset, int* adjusttopoffset) {
    return mHwc.getAdjustValue(adjustwidth, adjustheight,adjustloffset,adjusttopoffset);
}
#endif
