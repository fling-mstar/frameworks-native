...
public:
    ...
    void setAutoStereo(bool autoStereo);
    bool getAutoStereo();
    void computeLeftGeometry(const sp<const DisplayDevice>& hw, Mesh& mesh) const;
    void computeRightGeometry(const sp<const DisplayDevice>& hw, Mesh& mesh) const;
    ...
    // MStar Android Patch Begin
    uint32_t getIdentity() const { return sSequence; }
    // MStar Android Patch End
    /*
...
public:
    ...
    void UpdateConsumerUsageBits(HWComposer::HWCLayerInterface& layer);
    // MStar Android Patch End
...
private:
    ...
    // MStar Android Patch Begin
    void setConsumerUsageBits (uint32_t usage);
    uint32_t getConsumerUsageBits ();
    // MStar Android Patch End
    ...
    // MStar Android Patch Begin
    // Should surfacefinger auto stereo this layer
    bool mAutoStereo;
    // MStar Android Patch End
    ...
    // MStar Android Patch Begin
    Region mOutDirtyRegion;
    bool   mIsMMOverlay;
public:
    void drawCaptureData(const sp<const DisplayDevice>& hw, Texture texture);
    // MStar Android Patch End
};
